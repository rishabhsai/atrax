...
export const appOperations={
  ...
  'apps.operations.get':define('Inspect recent deployments, releases, database backups, and recorded action calls. Requires an app maintainer.','read',object({appId:string})),
