...
export const externalSharingOperations={
  ...
  'apps.guests.actions.set':define('Replace an accepted guest’s allowed actions using the revision observed in the guest list.','write',object({appId:id,personId:id,revision:id,actionNames:{type:'array',items:actionName,uniqueItems:true,maxItems:100}})),
