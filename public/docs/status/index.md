...
Available: new, dev, deploy, deploy --instant with claim-or-expire instant hosting, claim, inspect, logs, Worker endpoints, Static Assets, D1, migrations, unauthenticated public access, chat example, app contract, lockfile, JSON output, docs.json, llms.txt, and llms-full.txt.
