...
type AppView = "overview" | "access" | "sharing";
...
function AppContent({ appId, session, view }: { appId: string; session: Session; view: AppView }) {
  ...
  return (
    <div className={views.app}>
      ...
      <div hidden={view !== "access"} className={views.panel}>
      ...
      <div hidden={view !== "sharing"} className={views.panel}>
...
export function AppOverview() {
  ...
  const view = requestedView === "access" || requestedView === "sharing" ? requestedView : "overview";
