...
export type ExternalGuest = { personId: string; email: string; actionNames: string[] };
export type ExternalGuestInvitation = { id: string; email: string; status: string; actionNames: string[]; expiresAt: number };
